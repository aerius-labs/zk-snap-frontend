    ...
    return (
        <div className="w-full">
            <div className='flex mb-4 flex-row flex-wrap px-20 gap-4'>
                ...
                <Link href='/'>
                    <button className={`${router.pathname === '/' ? 'bg-custom-purple' : ''} text-gray-100 border border-custom-purple py-2 px-4 rounded-2xl`}>COMMUNITIES 29.5K</button>
                </Link>
                <Link href='/proposals'>
                    <button className={`text-gray-100 border border-custom-purple py-2 px-4 rounded-2xl ${router.pathname === '/proposals' ? 'bg-custom-purple' : ''}`}>PROPOSALS 119.5K</button>
                </Link>
                </div>
